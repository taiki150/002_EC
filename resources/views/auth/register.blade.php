            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="birth_day" class="col-md-4 col-form-label text-md-end">生年月日</label>

                            <div class="col-md-6">
                                <input id="birth_day" type="date" class="form-control @error('birth_day') is-invalid @enderror" name="birth_day" required autocomplete="birth_day">
                            </div>
                        </div>
